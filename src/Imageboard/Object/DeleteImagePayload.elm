...
module Imageboard.Object.DeleteImagePayload exposing (..)
...
-}
clientMutationId : SelectionSet (Maybe String) Imageboard.Object.DeleteImagePayload
clientMutationId =
...
image : SelectionSet decodesTo Imageboard.Object.Image
 -> SelectionSet (Maybe decodesTo) Imageboard.Object.DeleteImagePayload
image object____ =
      Object.selectionForCompositeField "image" [] (object____) (Basics.identity >> Decode.nullable)


deletedImageId : SelectionSet (Maybe Imageboard.ScalarCodecs.Id) Imageboard.Object.DeleteImagePayload
deletedImageId =
      Object.selectionForField "(Maybe ScalarCodecs.Id)" "deletedImageId" [] (Imageboard.ScalarCodecs.codecs |> Imageboard.Scalar.unwrapCodecs |> .codecId |> .decoder |> Decode.nullable)
